            ...
            <View style={styles.containerIn}>
                ...
                <View style={styles.containerIn2}>
                    ...
                    <View style={styles.containerIn2_s3}>
                        ...
                        <Text style={styles.containerIn2_s3_restaurantname}>new Hotel</Text>
                    ...
                    <View style={styles.containerIn2_s4}>
                        ...
                        <View style={styles.containerIn2_s4_QuantityCont}>
                            <Text style={styles.containerIn2_s4_QuantityCont_MinusText}>-</Text>
                            <TextInput style={styles.containerIn2_s4_QuantityCont_TextInput} />
                            <Text style={styles.containerIn2_s4_QuantityCont_PlusText}>+</Text>
                        </View>
